  ...
  return (
    <div className="rounded-tl-[30px] mt-[35.12px] bg-gradient-to-tl to-[#BDBDBD]/[100%]  via-transparent/10 from-[#D4D4D4]/[39%] w-[103px]  lg:w-[412.25px]  h-[105px] lg:h-[308px]   p-[1px] rounded-br-[30px] relative">
      ...
      <Image
        ...
        alt=""
      />
      <div className=" rounded-tl-[30px] items-center justify-center lg:gap-[70px] gap-[22px] flex flex-col bg-black w-full h-full  rounded-br-[30px] bg-gradient-to-tl from-white/[0%] via-[#0F151A] to-[#0F151A] relative">
        <Image
          src={icon}
