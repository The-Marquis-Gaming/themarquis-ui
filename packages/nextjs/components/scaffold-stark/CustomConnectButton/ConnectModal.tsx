...
const ConnectModal = ({ isOpen, onClose }: Props) => {
  ...
  const [isBlockchainWalletOpen, setIsBlockchainWalletOpen] = useState(false);
  ...
  function handleConnectWallet(e: React.MouseEvent<HTMLButtonElement>, connector: Connector): void {
    ...
    setIsBlockchainWalletOpen(true);
  }

  function handleBlockchainWalletClose() {
    setIsBlockchainWalletOpen(false);
              ...
              <div className="relative bg-[#21262B] rounded-[8px] w-full  px-[35px] py-[23px] pr-[15px]  flex items-center">
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-[60px]">
                    <Image src="/metamask.svg" alt="metamask" width={37} height={37} />
