...
const Page: React.FC = () => {
  const [depositStatus, setDepositStatus] = useState<"waiting" | "done" | "error">("waiting");
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen text-white">
      <div className="p-8 w-2/3">
        <h1 className="text-2xl font-bold text-center mb-10">TRANSACTION PROCESSING</h1>
        
        <div className="flex justify-center mb-10">
          <div className="flex justify-between w-full p-4 bg-gray-800 rounded-md">
            <div className="flex items-center">
              <div className={`w-4 h-4 rounded-full mr-2 ${getStatusStyle()}`}></div>
              <span>Deposit</span>
            </div>
        ...
        <div className="mb-10 w-full">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-2">
              <span className="bg-[#00ECFF] text-black px-4 py-1 rounded-full">Marquis</span>
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-2">
              <Image src="/logo-starknet.svg" alt="STRK" width={18} height={18} />
