  ...
  return (
    <div>
      <div className="max-w-[1700px] mx-auto px-[20px] py-[50px]">
        <h2 className="uppercase mb-[88px] text-center">privacy policy</h2>
        <p className="font-semibold mb-[18px]">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to The marquis, the software
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Quantum3 Labs,
              Fraser Street #04-23A Duo Tower Singapore 189352.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to The Marquis, accessible from{" "}
              <a
                href="https://themarquis.xyz/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://themarquis.xyz/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: contact@quantum3labs.com</p>
          </li>
          <li>
            <p>
