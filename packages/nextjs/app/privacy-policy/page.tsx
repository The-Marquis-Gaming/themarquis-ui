...
const PrivacyPolicyPage = () => {
  return (
    <div className="max-w-[1700px] mx-auto px-[20px] pb-[100px] pt-[50px]">
      <h2 className="uppercase mb-[88px] text-center">privacy policy</h2>
      <p className="font-semibold mb-[18px]">Last updated: October 07, 2024</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Quantum3 Labs, Fraser
            Street #04-23A Duo Tower Singapore 189352.
          </p>
        </li>
        <li>
          <p>
