        ...
        <div>
          <div className="flex justify-center items-center ">
              ...
              <div className="flex flex-col items-center justify-center lg:py-52 py-20 px-6">
                ...
                <div className="w-full flex justify-between pb-60 items-center">
                ...
                <div className="w-full bg-games">
                  <div className="flex gap-5 lg:text-5xl text-2xl items-center justify-center w-full py-10 px-10">
                    <span>GAMES</span>
                  </div>
                  <GameCarousel />
                </div>
          ...
          <div className="w-full lg:py-12 bg-degrad">
